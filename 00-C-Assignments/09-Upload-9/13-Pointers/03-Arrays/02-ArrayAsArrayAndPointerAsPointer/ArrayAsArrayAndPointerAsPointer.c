...
int main(int argc,char *argv[],char *envp[])
{
    ...
    printf("\n\n");
    printf("**Using array name as array i.e : value of xth element of iArray : iArray[x] and address of xth element of i Array : &iArray[x]**\n\n");
    ...
    printf("\n\n");
    printf("**Using pointer name as pointer i.e : value of xth element of iArray : ptr_iArray + x and address of xth element of i Array : ptr_iArray + x**\n\n");
