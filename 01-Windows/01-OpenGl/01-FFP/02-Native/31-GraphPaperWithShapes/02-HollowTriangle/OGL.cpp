...
void display(void)
{
    ...
    glVertex3f(cos(M_PI_2), sin(M_PI_2)-0.15f, 0.0f);
    glVertex3f(cos(-(M_PI/6.0f)), sin(-(M_PI/6.0f))-0.15f , 0.0f);
    glVertex3f(cos((7.0f*M_PI)/6.0f), sin((7.0f*M_PI)/6.0f)-0.15f, 0.0f);
	glEnd();
