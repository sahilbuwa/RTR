...
int initialize(void)
{
    ...
    // // Shader 1 uniforms
    // modelMatrixUniform = glGetUniformLocation(choosenProgramObject, "u_modelMatrix");
    // viewMatrixUniform = glGetUniformLocation(choosenProgramObject, "u_viewMatrix");
    // projectionMatrixUniform = glGetUniformLocation(choosenProgramObject, "u_projectionMatrix");
    
    // laUniform = glGetUniformLocation(choosenProgramObject, "u_la");
    // ldUniform = glGetUniformLocation(choosenProgramObject, "u_ld");
    // lsUniform = glGetUniformLocation(choosenProgramObject, "u_ls");
    // lightPositionUniform = glGetUniformLocation(choosenProgramObject, "u_lightPosition");

    // kaUniform = glGetUniformLocation(choosenProgramObject, "u_ka");
    // kdUniform = glGetUniformLocation(choosenProgramObject, "u_kd");
    // ksUniform = glGetUniformLocation(choosenProgramObject, "u_ks");
    // materialShininessUniform = glGetUniformLocation(choosenProgramObject, "u_materialShininess");

    // lightingEnabledUniform = glGetUniformLocation(choosenProgramObject, "u_lightingEnabled");
    ...
    laUniform = glGetUniformLocation(shaderProgramObject1, "u_la");
    ldUniform = glGetUniformLocation(shaderProgramObject1, "u_ld");
    lsUniform = glGetUniformLocation(shaderProgramObject1, "u_ls");
    lightPositionUniform = glGetUniformLocation(shaderProgramObject1, "u_lightPosition");
    ...
    laUniform = glGetUniformLocation(shaderProgramObject2, "u_la");
    ldUniform = glGetUniformLocation(shaderProgramObject2, "u_ld");
    lsUniform = glGetUniformLocation(shaderProgramObject2, "u_ls");
    lightPositionUniform = glGetUniformLocation(shaderProgramObject2, "u_lightPosition");
