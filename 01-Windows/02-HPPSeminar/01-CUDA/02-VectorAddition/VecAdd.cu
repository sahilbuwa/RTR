...
int main(void)
{
    ...
    char str[128];
    if(bAccuracy == false)
        sprintf(str, "Comparison of CPU and GPU vectore addition is not within accuracy of 0.000001 at array index %d", breakValue);
    else
        sprintf(str, "Comparison of CPU and GPU vectore addition is within accuracy of 0.000001");
    // Output
