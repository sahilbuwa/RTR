...
GLfloat lightPositionZero[] = {0.0f, 0.0f, 6.0f, 1.0f};
...
void update(void)
{
    ...
    lightPositionZero[0] = 0.4f * cosf(angle * M_PI / 180.0f);
    lightPositionZero[1] = 0.4f * sinf(angle * M_PI / 180.0f);
}
