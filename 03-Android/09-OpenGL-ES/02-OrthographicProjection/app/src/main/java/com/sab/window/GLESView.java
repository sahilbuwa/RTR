...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer
{
	...
	private void initialize()
	{
		...
		ByteBuffer byteBuffer = ByteBuffer.allocateDirect(triangleVertices.length * 4); // sizeof replacement
		...
		// Clearing the screen to blue color
		GLES32.glClearColor(0.0f, 0.0f, 1.0f, 1.0f);

		// Initialization of Projection Matrix
		Matrix.setIdentityM(orthographicProjectionMatrix, 0); // OpenGL purpose
	}
