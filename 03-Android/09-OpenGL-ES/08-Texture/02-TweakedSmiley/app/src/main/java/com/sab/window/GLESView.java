...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer
{
	...
	private void initialize()
	{
		...
		singleTapUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_keyPressed");
	...
	private void display()
	{
		...
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_texcoord[0]);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, texcoords.length * 4, texcoordsBuffer, GLES32.GL_DYNAMIC_DRAW);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
