...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer
{
	...
	private void display()
	{
		...
		float rotationMatrixZ1[] = new float[16];
		Matrix.setIdentityM(rotationMatrixZ1, 0);

		float rotationMatrixZ2[] = new float[16];
		Matrix.setIdentityM(rotationMatrixZ2, 0);

		float rotationMatrixZ3[] = new float[16];
		Matrix.setIdentityM(rotationMatrixZ3, 0);
		...
		Matrix.rotateM(rotationMatrixZ1, 0, (float)shoulder, 0.0f, 0.0f, 1.0f);

		Matrix.translateM(translationMatrix, 0, 1.0f, 0.0f, 0.0f);

		Matrix.scaleM(scaleMatrix, 0, 2.0f, 0.5f, 1.0f);
		Matrix.multiplyMM(modelMatrix, 0, rotationMatrixZ1, 0, translationMatrix, 0);
		...
		GLES32.glUniform3f(sphereColorUniform, 0.5f, 0.35f, 0.05f);
		// Draw Shoulder
		// bind vao
		GLES32.glBindVertexArray(vao_sphere[0]);
		...
		Matrix.rotateM(rotationMatrixZ2, 0, (float)elbow, 0.0f, 0.0f, 1.0f);

		Matrix.multiplyMM(rotationMatrixZ2, 0, rotationMatrixZ2, 0, translationMatrix, 0);
		Matrix.multiplyMM(modelMatrix, 0, modelMatrix, 0, rotationMatrixZ2, 0);
		...
		Matrix.rotateM(rotationMatrixZ3, 0, (float)wrist, 0.0f, 0.0f, 1.0f);
		
		Matrix.setIdentityM(scaleMatrix, 0);
		Matrix.scaleM(scaleMatrix, 0, 1.0f, 0.5f, 1.0f);
		Matrix.setIdentityM(translationMatrix, 0);
		Matrix.translateM(translationMatrix, 0, 0.5f, 0.0f, 0.0f);
		
		Matrix.multiplyMM(rotationMatrixZ3, 0, rotationMatrixZ3, 0, translationMatrix, 0);
		Matrix.multiplyMM(rotationMatrixZ3, 0, rotationMatrixZ3, 0, scaleMatrix, 0);
		Matrix.multiplyMM(modelMatrix, 0, modelMatrix, 0, rotationMatrixZ3, 0);
