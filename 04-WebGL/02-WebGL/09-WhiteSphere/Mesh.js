...
function Mesh()
{
	...
	this.prepareToDraw=function()
	{
		...
		gl.vertexAttribPointer(webGLMacros.SAB_ATTRIBUTE_POSITION,
							   3,
							   gl.FLOAT,
							   false,0,0);
		gl.enableVertexAttribArray(webGLMacros.SAB_ATTRIBUTE_POSITION);
		gl.vertexAttrib3f(webGLMacros.SAB_ATTRIBUTE_COLOR, 1.0, 1.0, 1.0);
		...
		gl.bufferData(gl.ARRAY_BUFFER,
					  norms,
					  gl.STATIC_DRAW);
		gl.vertexAttribPointer(webGLMacros.SAB_ATTRIBUTE_NORMAL,
							   3,
							   gl.FLOAT,
							   false,0,0);
		...
		gl.bufferData(gl.ARRAY_BUFFER,
					  texCoords,
					  gl.STATIC_DRAW);
		gl.vertexAttribPointer(webGLMacros.SAB_ATTRIBUTE_TEXTURE0,
